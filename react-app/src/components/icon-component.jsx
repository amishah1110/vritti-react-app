...
const iconSet = {
  bulb: ({ color }) => (
    <svg className="icon" id="icon1" xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="50px" fill={color}>
      <path d="M480-80q-33 0-56.5-23.5T400-160h160q0 33-23.5 56.5T480-80ZM320-200v-80h320v80H320Zm10-120q-69-41-109.5-110T180-580q0-125 87.5-212.5T480-880q125 0 212.5 87.5T780-580q0 81-40.5 150T630-320H330Zm24-80h252q45-32 69.5-79T700-580q0-92-64-156t-156-64q-92 0-156 64t-64 156q0 54 24.5 101t69.5 79Zm126 0Z"/>
    </svg>
  ),

  fan: ({color}) =>(
    <svg id="icon2" className="icon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  gasmeter: ({color}) => (
    <svg className="icon" id="icon3" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  heat: ({color}) =>(
    <svg className="icon" id="icon4" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  memory: ({color})=>(
    <svg className="icon" id="icon5" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  oilbarrel: ({color}) => (
    <svg className="icon" id="icon6" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  powersettings: ({color}) =>(
    <svg className="icon" id="icon7" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  propanetank: ({color}) => (
    <svg className="icon" id="icon8" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  thermostat: ({color}) => (
    <svg className="icon" id="icon9" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  timer: ({color}) => (
    <svg className="icon" id="icon10" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
      <path d="M360-840v-80h240v80H360Zm80 440h80v-240h-80v240Zm40 320q-74 0-139.5-28.5T226-186q-49-49-77.5-114.5T120-440q0-74 28.5-139.5T226-694q49-49 114.5-77.5T480-800q62 0 119 20t107 58l56-56 56 56-56 56q38 50 58 107t20 119q0 74-28.5 139.5T734-186q-49 49-114.5 77.5T480-80Zm0-80q116 0 198-82t82-198q0-116-82-198t-198-82q-116 0-198 82t-82 198q0 116 82 198t198 82Zm0-280Z"/>
    </svg>
  ),

  valve: ({color}) => (
    <svg className="icon" id="icon11" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
  ...
  waterdrop: ({color}) =>(
    <svg className="icon" id="icon12" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
      <path d="M491-200q12-1 20.5-9.5T520-230q0-14-9-22.5t-23-7.5q-41 3-87-22.5T343-375q-2-11-10.5-18t-19.5-7q-14 0-23 10.5t-6 24.5q17 91 80 130t127 35ZM480-80q-137 0-228.5-94T160-408q0-100 79.5-217.5T480-880q161 137 240.5 254.5T800-408q0 140-91.5 234T480-80Zm0-80q104 0 172-70.5T720-408q0-73-60.5-165T480-774Q361-665 300.5-573T240-408q0 107 68 177.5T480-160Zm0-320Z"/>
    </svg>
),

  wifi: ({color}) => (
    <svg className="icon" id="icon13" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={color}>
...
const handleDragStart = (e) => {
  console.log("icon drag started:", iconKey, id)
  ...
  e.dataTransfer.setData('application/json', JSON.stringify({ id, iconKey, offsetX, offsetY, topic: currentTopic}));
};
...
const handleDrop = (e) => {
  const iconKey = e.dataTransfer.getData('iconKey');  // Retrieve the dragged icon key
  if (iconKey) {
    const Icon = iconSet[iconKey];  // Use the iconKey to get the correct icon from the iconSet
    setDroppedIcons((prev) => {
      return [...prev, { id: Date.now(), iconKey, topic: ''}]; 
    });
  }
  e.preventDefault();
};
...
function updateLevel(latestValue) {
  debugger
  const level = latestValue; // Get user input
  const tankHeight = 50; // Height of the tank in SVG units
  const waterRect = document.getElementById('icon1'); // Reference to the water rectangle
